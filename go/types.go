// Package sudoku provides a Go client for the Sudoku Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/sudoku?utm_source=go&utm_medium=readme
package sudoku
...
// Request contains the parameters for the Sudoku Generator API.
//
// Parameters:
//   - difficulty: string - The difficulty level of the Sudoku puzzle to generate
type Request struct {
...
// ResponseData contains the data returned by the Sudoku Generator API.
...
// PuzzleData represents the puzzle object.
...
// SolutionData represents the solution object.
