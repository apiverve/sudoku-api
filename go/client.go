...
const (
	baseURL        = "https://api.apiverve.com/v1/sudoku"
	defaultTimeout = 30 * time.Second
)

// Client is the Sudoku Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Sudoku Generator API client.
...
// Execute makes a request to the Sudoku Generator API with typed parameters.
//
